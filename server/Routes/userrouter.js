...
import { userdata, registeruser, logout, login, changedp, insertidea, removeidea, addcontributor, isauth, addbadge, allBadges } from '../Controller/DataController.js';
...
userrouter.post("/changeprofile",upload.single("currimage"),userAuth,changedp);
